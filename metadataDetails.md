...
This document outlines the structure of the data files and the specific attributes found in `FileInfoForRIPA.csv`.
...
| :--- | :--- |
| **Filename** | **See "Filename Format" above for naming convention details.** |
| **Exclude** | **See "Exclusion Criteria" below for specific codes.** |
